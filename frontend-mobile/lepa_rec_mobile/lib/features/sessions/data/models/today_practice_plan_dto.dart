...
class TodayPracticePlanDto {
  ...
  factory TodayPracticePlanDto.fromJson(Map<String, dynamic> json) {
    ...
    final distancedJournalChoices = journalChoicesList
        .map((item) =>
            DistancedJournalChallengeDto.fromJson(item as Map<String, dynamic>))
        .toList();

    final reflectionPromptJson = json['reflectionPrompt'] as Map<String, dynamic>?;
    ...
    return TodayPracticePlanDto(
      ...
      isReflectionCompleted:
          json['isReflectionCompleted'] as bool? ?? false,
  ...
  Map<String, dynamic> toJson() => {
        ...
        'distancedJournalChoices':
            distancedJournalChoices.map((c) => c.toJson()).toList(),
